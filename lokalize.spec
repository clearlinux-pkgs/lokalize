...
Version  : 23.04.0
Release  : 52
URL      : https://download.kde.org/stable/release-service/23.04.0/src/lokalize-23.04.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.0/src/lokalize-23.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.0/src/lokalize-23.04.0.tar.xz.sig
...
%prep
%setup -q -n lokalize-23.04.0
cd %{_builddir}/lokalize-23.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682012204
mkdir -p clr-build
pushd clr-build

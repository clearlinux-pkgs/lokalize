...
Source0  : https://download.kde.org/stable/release-service/22.04.2/src/lokalize-22.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.2/src/lokalize-22.04.2.tar.xz.sig
...
%prep
%setup -q -n lokalize-22.04.2
cd %{_builddir}/lokalize-22.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654822903
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/lokalize-22.04.2/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/lokalize/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/lokalize-22.04.2/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/lokalize/ee03d68f6be20b170e5ea5d114d6acafb3f2d1dc
cp %{_builddir}/lokalize-22.04.2/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/lokalize/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/lokalize-22.04.2/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/lokalize/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/lokalize-22.04.2/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/lokalize/2123756e0b1fc8243547235a33c0fcabfe3b9a51
cp %{_builddir}/lokalize-22.04.2/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/lokalize/81b58c89ceef8e9f8bd5d00a287edbd15f9d3567
cp %{_builddir}/lokalize-22.04.2/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/lokalize/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/lokalize-22.04.2/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/lokalize/7d9831e05094ce723947d729c2a46a09d6e90275
pushd clr-build
%make_install
popd

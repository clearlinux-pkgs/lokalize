...
Version  : 22.08.0
Release  : 43
URL      : https://download.kde.org/stable/release-service/22.08.0/src/lokalize-22.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/lokalize-22.08.0.tar.xz
...
%prep
%setup -q -n lokalize-22.08.0
cd %{_builddir}/lokalize-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661532322
mkdir -p clr-build
pushd clr-build

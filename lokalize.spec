...
%prep
%setup -q -n lokalize-20.08.2
cd %{_builddir}/lokalize-20.08.2
...
cp %{_builddir}/lokalize-20.08.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/lokalize/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
pushd clr-build
%make_install
popd
%find_lang lokalize

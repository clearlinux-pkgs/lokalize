...
Source0  : https://download.kde.org/stable/release-service/21.04.2/src/lokalize-21.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.04.2/src/lokalize-21.04.2.tar.xz.sig
...
%prep
%setup -q -n lokalize-21.04.2
cd %{_builddir}/lokalize-21.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1623405331
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/lokalize-21.04.2/COPYING %{buildroot}/usr/share/package-licenses/lokalize/8cf4afb0636055f7cacd1b6955e0e8ebec7888f5
cp %{_builddir}/lokalize-21.04.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/lokalize/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
pushd clr-build
%make_install
popd
%find_lang lokalize

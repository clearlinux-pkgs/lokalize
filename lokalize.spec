...
Source0  : https://download.kde.org/stable/release-service/23.08.2/src/lokalize-23.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.2/src/lokalize-23.08.2.tar.xz.sig
...
%prep
%setup -q -n lokalize-23.08.2
cd %{_builddir}/lokalize-23.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697232697
mkdir -p clr-build
pushd clr-build
